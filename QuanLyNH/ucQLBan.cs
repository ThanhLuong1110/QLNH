    ...
    public partial class ucQLBan : UserControl
    {
        ...
        private void btnThanhToan_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // Kiểm tra nếu kết quả không null (trường hợp bàn có khách nhưng chưa gọi món)
            ...
            if (result == DialogResult.Yes)
            {
                try
                {
                    ...
                    // A. Cập nhật bảng HoaDon: 
                    // - Set TrangThai = 1 (tinyint) 
                    // - Update TongTien
                    // (Nếu bạn có cột NgayRa, hãy thêm: , NgayRa = GETDATE() vào câu query bên dưới)
